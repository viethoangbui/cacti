				...
				<tr>
					...
					<td>
						<select id='columns' onChange='applyGraphFilter()'>
							...
							<option value='8'<?php if (get_request_var('columns') == '8') {?> selected<?php }?>><?php print __('%d Columns', 8);?></option>
							<option value='10'<?php if (get_request_var('columns') == '10') {?> selected<?php }?>><?php print __('%d Columns', 10);?></option>
