<?php
function cus_initialize_realtime_step_and_window() {
...
function cus_set_default_graph_action() {
...
function cus_html_graph_validate_preview_request_vars() {
				...
				<tr>
					...
					<td>
						<select id='columns' onChange='applyGraphFilter()'>
							...
							<option value='12'<?php if (get_request_var('columns') == '12') {?> selected<?php }?>><?php print __('%d Columns', 12);?></option>
						</select>
					</td>
					<td>
						<span>
...
function cus_html_graph_new_graphs($page, $host_id, $host_template_id, $selected_graphs_array) {
	$snmp_query_id     = 0;
...
function cus_html_graph_custom_data($host_id, $host_template_id, $snmp_query_id, $form_type, $form_id1, $form_array2) {
	/* ================= input validation ================= */
