...
if ($config['poller_id'] == 1 || $config['connection'] == 'online') {
	$menu = array(
		...
		__('Thread List') => array(
			'syncDevice_OSS.php' => __('Đồng bộ thiết bị từ OSS'),
			'loadDevice.php' => __('Load thiết bị lên hệ thống'),
			'syncDevicePortCustomer.php' => __('Đồng bộ port thiết bị khách hàng'),
			'syncCustomer.php' => __('Đồng bộ khách hàng'),
		)
	);
} else {
	$menu = array(
...
$user_auth_realm_filenames = array(
	...
	'color.php' => 5,
	'data_debug.php' => 15,
	'syncDevice_OSS.php' => 15,
	'loadDevice.php' => 15,
	'syncDevicePortCustomer.php' => 15,
	'syncCustomer.php' => 15,
...
$navigation = array(
	...
	'graph_view.php:preview_Customer' => array(
		'title' => __('Preview Mode'),
		'mapping' => '',
		'url' => 'graph_view.php?action=preview_Customer',
		'level' => '0'
	),
	'Cus_Graphs_View.php:preview' => array(
		'title' => __('Preview Mode'),
		'mapping' => '',
		'url' => 'Cus_Graphs_View.php?action=preview',
		'level' => '0'
	),
	'graph.php:' => array(
